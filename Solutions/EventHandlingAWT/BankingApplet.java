...
public class BankingApplet extends Applet implements ItemListener
{
	...
	public void init()
	{
		...
		accountSelection.addItemListener(this);
	...
	{
		// not strictly necessary as accountSelection
		// is the only component registered!
